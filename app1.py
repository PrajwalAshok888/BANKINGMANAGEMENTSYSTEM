...
def history(acct):
    ...
    if data_file is not None:
        ...
        l_title = tkinter.Message(ds_window, text="BANK MANAGEMENT SYSTEM", relief="raised", width=1000, padx=600,
                                  pady=0,
...
def logininpage(master):
    ...
    try:
        ...
        l1 = tkinter.Label(login_in_page, image=image_reference)
        l1.pack()
